...
$_LANG['domains']['deTermsDescription1'] = "را بپذیرد .DE برا ی ثبت یک دامنه جدید، انتقال و یا تغییر اطلاعات ثبت شده، ثبت کننده باید صریحا شرایط";
$_LANG['domains']['deTermsDescription2'] = "(See full text of .de terms and conditions: http://www.denic.de/en/bedingungen.html.)";
$_LANG['directDebitPageTitle'] = "Direct Debit پرداخت";
$_LANG['directDebitHeader'] = "Direct Debit پرداخت";
$_LANG['directDebitErrorNoBankName'] = "نام بانک خود را وارد کنید";
$_LANG['directDebitErrorAccountType'] = "نوع حساب بانکی خود را وارد کنید";
$_LANG['directDebitErrorNoABA'] = "بانک خود را وارد کنید ABA کد";
$_LANG['directDebitErrorAccNumber'] = "شماره حساب خود را وارد کنید";
$_LANG['directDebitErrorConfirmAccNumber'] = "شماره حساب خود را برای تایید مجدد وارد کنید";
$_LANG['directDebitErrorAccNumberMismatch'] = "شماره حساب بانک و تاییدیه مطابقت ندارند";
$_LANG['directDebitThanks'] = "با تشکر از ارسال جزییات توسط شما. ما در چند روز آینده در تلاش برای پردازش جزییات پرداخت شما خواهیم بود و در صورت بروز هرگونه مشکل با شما تماس خواهیم گرفت";
$_LANG['directDebitPleaseSubmit'] = "ارسال کنید Direct Debit لطفا جزییات حساب بانکی خود را برای پرداخت از طریق .";
...
$_LANG['cPanel']['quickShortcuts'] = "میانبر سریع";
$_LANG['cPanel']['emailAccounts'] = "اکانت های ایمیل";
$_LANG['cPanel']['forwarders'] = "فرستنده ها";
$_LANG['cPanel']['autoresponders'] = "پاسخگوی خودکار";
$_LANG['cPanel']['fileManager'] = "مدیریت فایل";
$_LANG['cPanel']['backup'] = "پشتیبان";
$_LANG['cPanel']['subdomains'] = "زیردامنه ها";
$_LANG['cPanel']['addonDomains'] = "افزونه دامنه";
$_LANG['cPanel']['cronJobs'] = "Cron Jobs";
$_LANG['cPanel']['mysqlDatabases'] = "MySQL پایگاه داده های";
$_LANG['cPanel']['phpMyAdmin'] = "phpMyAdmin";
$_LANG['cPanel']['awstats'] = "Awstats";

$_LANG['cPanel']['createEmailAccount'] = "ایجاد سریع اکانت ایمیل";
$_LANG['cPanel']['usernamePlaceholder'] = "نام شما";
$_LANG['cPanel']['passwordPlaceholder'] = "رمز عبور مورد نظر";
$_LANG['cPanel']['create'] = "ایجاد";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "اکانت ایمیل با موفقیت ایجاد شد!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "ایجاد اکانت ایمیل ناموفق بود: ";
...
$_LANG['orderForm']['checkout'] = "وارسی";
$_LANG['orderForm']['alreadyRegistered'] = "قبلا ثبت نام شده؟";
$_LANG['orderForm']['createAccount'] = "ایجاد یک اکانت جدید";
$_LANG['orderForm']['enterPersonalDetails'] = "لطفا اطلاعات شخصی و اطلاعات مربوط به پرداخت صورت حساب را برای بررسی وارد کنید";
$_LANG['orderForm']['correctErrors'] = "لطفا خطاهای زیر را قبل از ادامه اصلاح کنید";
$_LANG['orderForm']['existingCustomerLogin'] = "لاگین کاربر موجود";
$_LANG['orderForm']['emailAddress'] = "ادرس ایمیل";
$_LANG['orderForm']['personalInformation'] = "اطلاعات شخصی";
$_LANG['orderForm']['firstName'] = "نام";
$_LANG['orderForm']['lastName'] = "نام خانوادگی";
$_LANG['orderForm']['phoneNumber'] = "شماره تماس";
$_LANG['orderForm']['billingAddress'] = "Billing Address";
$_LANG['orderForm']['companyName'] = "نام شرکت";
$_LANG['orderForm']['optional'] = "اختیاری";
$_LANG['orderForm']['streetAddress'] = "آدرس خیابان";
$_LANG['orderForm']['streetAddress2'] = "آدرس خیابان 2";
...
$_LANG['orderForm']['cvv'] = "CVVکد امنیتی";
$_LANG['orderForm']['additionalNotes'] = "مطالب بیشتر";
$_LANG['orderForm']['continueToClientArea'] = "Continue To Client Area";
$_LANG['orderForm']['reviewDomainAndAddons'] = "لطفا دامنه انتخابی خود و هر افزونه موجود برای آن را بررسی کنید";
$_LANG['orderForm']['addToCart'] = "اضافه کردن به سبد";
$_LANG['orderForm']['configureDesiredOptions'] = "گزینه های مورد نظر خود را پیکربندی کنید و برای پرداخت ادامه دهید";
$_LANG['orderForm']['haveQuestionsContact'] = "سوالی دارید؟ برای رسیدگی به سوالات با تیم فروش ما تماس بگیرید";
...
$_LANG['orderForm']['productOptions'] = "محصولات/گزینه ها";
...
$_LANG['orderForm']['applyPromoCode'] = "درخواست کد تخفیف";
$_LANG['orderForm']['estimateTaxes'] = "برآورد مالیات";
$_LANG['orderForm']['removePromotionCode'] = "حذف ارتقاع کد";
$_LANG['orderForm']['updateTotals'] = "بروز رسانی مجموعه ها";
...
$_LANG['orderForm']['totals'] = "مجموعه ها";
$_LANG['orderForm']['includedWithPlans'] = "مشمول هر طرح";
$_LANG['orderForm']['whatIsIncluded'] = "شامل چه چیزی است؟";
$_LANG['orderForm']['errorNoProductGroup'] = "هیچ یک از دسته بندی های محصولات لود نشد";
$_LANG['orderForm']['errorNoProducts'] = "گروه محصول شامل هیچ محصول قابل مشاهده ای نیست";

$_LANG['cloudSlider']['feature01Title'] = "حداکثر آپ تایم سرور";
$_LANG['cloudSlider']['feature01Description'] = "سرور آپ تایم برای همه کسب و کارها حیاتی است- آنرا بعنوان ضربان قلب کسب و کار خود در نظر بگیرید. فایل ها و پایگاه داده سرور، ایمیل ها و وب سرور یکی از ضروری ترین بخش های فرآیند کسب و کار هستند و خرابی آنها اثرات منفی مستقیمی در بهره وری، فروش، کارکنان و رضایت مشتری دارد";
...
$_LANG['cloudSlider']['feature02Description'] = "خدمات ما توسط صدها سرور و مراکز داده واقع در سراسر جهان طراحی شده است. بنابراین شما میتوانید براحتی استراحت کنید درحالی که می دانید وب سایت شما در هر نقطه از جهان قابل دسترسی است. علاوه براین، ما با ارائه ابزار نظارت امکان تجزیه و تحلیل تخصصی را برای شما مهیا کرده ایم. ترافیک وب سایت یک گام مهم در بهبود بهره وری و محبوبیت سایت شما است، همچنین پیگیری اینکه بازدید کنندگان شما از کجا هستند، چه وقتی از روز سایت شما را بازدید کرده اند، و چه مدت در سایت شما مانده اند را مهیا کرده ایم. تعهد ما به بازار گسترده جهانی ثبت دامنه، منجر به پیشنهاد معروفترین دامنه های سطح بالا برای ثبت نام می شود.";
